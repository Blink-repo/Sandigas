    ...
    <section class="flex justify-center items-center bg-primary py-12">
      <div class="max-w-7xl">
        ...
        <div class="grid grid-cols-3 gap-4 py-2">
          <div class="flex items-center justify-center p-1 sm:p-6 col-span-1">
            <img class="w-full md:h-52 text-gray-500 fill-current rounded-lg object-contain sm:object-cover" src="/img/logos/desco.png" alt="">
          </div>
          <div class="flex items-center justify-center p-1 sm:p-6 col-span-1">
            <img class="h-24 md:h-44 text-gray-500 fill-current object-contain sm:object-cover" src="/img/logos/logo_marcke.png" alt="">
          </div>
          <div class="flex items-center justify-center p-1 sm:p-6 col-span-1">
